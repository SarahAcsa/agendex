...
public class Funcionario extends Entidade implements Serializable {
	...
	@Length(min = 0, max = 255, message = "O limite do campo nome do funcionário é de 255 caracteres.", groups = AmbientValidator.class)
	private String nome;

	@NotEmpty(message = "Informe a nome social.", groups = AmbientValidator.class)
	@Column(length = 255, nullable = false)
	@Length(min = 0, max = 255, message = "O limite do nome social do funcionário é de 255 caracteres.", groups = AmbientValidator.class)
	private String nomeSocial;

	@NotEmpty(message = "Informe o CPF.", groups = AmbientValidator.class)
	@Column(length = 15, nullable = false, unique = true)
	@Length(min = 11, max = 14, message = "O limite do campo CPF do funcionário é de 11 caracteres.", groups = AmbientValidator.class)
	private String cpf;

	@NotEmpty(message = "Informe o RG.", groups = AmbientValidator.class)
	@Column(length = 7, nullable = false, unique = true)
	@Length(min = 7, max = 7, message = "O limite do campo RG do funcionário é de 7 caracteres.", groups = AmbientValidator.class)
	private String rg;

	@NotEmpty(message = "Informe o telefone.", groups = AmbientValidator.class)
	@Column(length = 15, nullable = false)
	@Length(min = 0, max = 15, message = "O limite do campo telefone do funcionário é de 15 caracteres.", groups = AmbientValidator.class)
	private String telefone;

	@NotEmpty(message = "Informe o e-mail.", groups = AmbientValidator.class)
	@Column(length = 255, nullable = false, unique = true)
	@Length(min = 0, max = 255, message = "O limite do campo e-mail do funcionário é de 255 caracteres.", groups = AmbientValidator.class)
	...
	@Length(min = 0, max = 10, message = "O limite do campo data de funcionário é de 10 caracteres.", groups = AmbientValidator.class)
